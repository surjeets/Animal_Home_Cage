<?php
   ...
   function drawFile($f, $ts, $sel) {
      ...
      $lapseCount = "";
      switch ($fType) {
         case 'v': $fIcon = 'glyphicon glyphicon-film'; break;
         case 't': 
            $fIcon = 'glyphicon glyphicon-time';
            $lapseCount = '(' . count(findLapseFiles($f)). ')';
            break;
         case 'i': $fIcon = 'glyphicon glyphicon-picture'; break;
         default : $fIcon = 'glyphicon glyphicon-picture'; break;
      }
      $duration ='';
      ...
      echo "<button type='submit' name='delete1' value='$f' class='glyphicon glyphicon-remove'></button>";
      echo "&nbsp;&nbsp;<a target=\"_blank\" href=\"" . MEDIA_PATH . "/$rFile\">$fNumber</a>&nbsp;";
      echo "<span class='$fIcon' style='color:gray'></span>";
...
<html>
   <head>
      ...
      <script>
         ...
         var linksBase = 'select_cam_preview.php?preview=';
...
<nav class="navbar navbar-inverse navbar-fixed-top">
  <div class="container-fluid">
    ...
    <ul class="nav navbar-nav">
      ...
      <li class="active"><a href="select_cam_preview.php">Preview</a></li>
      ...
      <div class="container-fluid">
      <form action="select_cam_preview.php" method="POST">
         <div id='preview' style="display: none; min-height: <?php echo $previewSize ?>px">
            <h1>
               <?php echo TXT_PREVIEW ?>: <span id='media-title'></span>
               <input type='button' value='&larr;' class='btn btn-warning' name='prev'>
               <input type='button' value='&rarr;' class='btn btn-warning' name='next'>

               <button class='btn btn-success' type='submit' name='download1'><?php echo BTN_DOWNLOAD; ?></button>
         ...
         <button class='btn btn-info' type='submit' name='action' value='selectNone'><?php echo BTN_SELECTNONE; ?></button>
         <button class='btn btn-info' type='submit' name='action' value='selectAll'><?php echo BTN_SELECTALL; ?></button>
         <button class='btn btn-info' type='submit' name='action' value='zipSel'><?php echo BTN_GETZIP; ?></button>
